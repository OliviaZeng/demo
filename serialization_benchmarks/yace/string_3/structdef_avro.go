...
func avroUnmarshal(d []byte, o interface{}, unmarshalFunc func([]byte) (interface{}, []byte, error)) error {
	...
	object.BirthDay = m["birthday"].(string)
	object.Phone = m["phone"].(string)
	object.Siblings = m["siblings"].(string)
	object.Spouse = m["spouse"].(string)
	object.Money = m["money"].(string)
	return nil
}
