...
func generate() []*A {
	...
	for i := 0; i < 1000; i++ {
		a = append(a, &A{
			Name:     randString(16),
			BirthDay: randString(16),
			Phone:    randString(16),
			Siblings: randString(16),
			Spouse:   randString(16),
			Money:    randString(16),
		})
	}
	return a
...
func (s *FlatBufferSerializer) Marshal(o interface{}) []byte {
	...
	birthday := builder.CreateString(a.BirthDay)
	phone := builder.CreateString(a.Phone)
	siblings := builder.CreateString(a.Siblings)
	spouse := builder.CreateString(a.Spouse)
	money := builder.CreateString(a.Money)

	FlatBufferAStart(builder)
	FlatBufferAAddName(builder, name)
	FlatBufferAAddBirthDay(builder, birthday)
	FlatBufferAAddPhone(builder, phone)
	FlatBufferAAddSiblings(builder, siblings)
	FlatBufferAAddSpouse(builder, spouse)
	FlatBufferAAddMoney(builder, money)
...
func (s *FlatBufferSerializer) Unmarshal(d []byte, i interface{}) error {
	...
	a.BirthDay = string(o.BirthDay())
	a.Phone = string(o.Phone())
	a.Siblings = string(o.Siblings())
	a.Spouse = string(o.Spouse())
	a.Money = string(o.Money())
...
func (x *CapNProtoSerializer) Marshal(o interface{}) []byte {
	...
	c := NewRootCapnpA(s)
	c.SetName(a.Name)
	c.SetBirthDay(a.BirthDay)
	c.SetPhone(a.Phone)
	c.SetSiblings(a.Siblings)
...
func (x *CapNProtoSerializer) Unmarshal(d []byte, i interface{}) error {
	...
	a.BirthDay = string(o.BirthDayBytes())
	a.Phone = string(o.PhoneBytes())
	a.Siblings = string(o.SiblingsBytes())
	a.Spouse = string(o.SpouseBytes())
	a.Money = string(o.MoneyBytes())
	return nil
}
...
func (s *HproseSerializer) Marshal(o interface{}) []byte {
	...
	writer.WriteString(a.BirthDay)
	writer.WriteString(a.Phone)
	writer.WriteString(a.Siblings)
	writer.WriteString(a.Spouse)
	writer.WriteString(a.Money)
	return buf.Bytes()[l:]
}
...
func (s *HproseSerializer) Unmarshal(d []byte, i interface{}) error {
	...
	o.BirthDay, _ = reader.ReadString()
	o.Phone, _ = reader.ReadString()
	o.Siblings, _ = reader.ReadString()
	o.Spouse, _ = reader.ReadString()
	o.Money, _ = reader.ReadString()
	return nil
}
...
func generateProto() []*ProtoBufA {
	...
	for i := 0; i < 1000; i++ {
		a = append(a, &ProtoBufA{
			...
			BirthDay: proto.String(randString(16)),
			Phone:    proto.String(randString(16)),
			Siblings: proto.String(randString(16)),
			Spouse:   proto.String(randString(16)),
			Money:    proto.String(randString(16)),
		})
	}
	return a
}
