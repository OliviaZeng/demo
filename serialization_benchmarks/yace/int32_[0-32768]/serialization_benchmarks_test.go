...
func generate() []*A {
	...
	for i := 0; i < 1000; i++ {
		...
		a = append(a, &A{
			Name:     rand.Intn(32768),
			BirthDay: rand.Intn(32768),
			Phone:    rand.Intn(32768),
			Siblings: rand.Intn(32768),
			Spouse:   rand.Intn(32768),
			Money:    rand.Intn(32768),
		})
	}
	return a
}
...
func generateProto() []*ProtoBufA {
	...
	for i := 0; i < 1000; i++ {
		...
		a = append(a, &ProtoBufA{
			Name:     proto.Int32(rand.Int31n(32768)),
			BirthDay: proto.Int32(rand.Int31n(32768)),
			Phone:    proto.Int32(rand.Int31n(32768)),
			Siblings: proto.Int32(rand.Int31n(32768)),
			Spouse:   proto.Int32(rand.Int31n(32768)),
			Money:    proto.Int32(rand.Int31n(32768)),
		})
	}
	return a
}
...
func generateGogoProto() []*GogoProtoBufA {
	...
	for i := 0; i < 1000; i++ {
		...
		a = append(a, &GogoProtoBufA{
			Name:     rand.Int31n(32768),
			BirthDay: rand.Int31n(32768),
			Phone:    rand.Int31n(32768),
			Siblings: rand.Int31n(32768),
			Spouse:   rand.Int31n(32768),
			Money:    rand.Int31n(32768),
		})
	}
	return a
}
