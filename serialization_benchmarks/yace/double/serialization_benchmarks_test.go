...
func generate() []*A {
	...
	for i := 0; i < 1000; i++ {
		a = append(a, &A{
			Name:     rand.Float64(),
			BirthDay: rand.Float64(),
			Phone:    rand.Float64(),
			Siblings: rand.Float64(),
			Spouse:   rand.Float64(),
			Money:    rand.Float64(),
		})
	}
...
func (s *FlatBufferSerializer) Marshal(o interface{}) []byte {
	...
	FlatBufferAAddName(builder, a.Name)
	FlatBufferAAddPhone(builder, a.Phone)
	FlatBufferAAddBirthDay(builder, a.BirthDay)
	FlatBufferAAddSiblings(builder, a.Siblings)
...
func (s *FlatBufferSerializer) Unmarshal(d []byte, i interface{}) error {
	...
	a.Name = o.Name()
	a.BirthDay = o.BirthDay()
	a.Phone = o.Phone()
	a.Siblings = o.Siblings()
	a.Spouse = o.Spouse()
	a.Money = o.Money()
...
func (s *HproseSerializer) Marshal(o interface{}) []byte {
	...
	l := buf.Len()
	writer.WriteFloat64(a.Name)
	writer.WriteFloat64(a.BirthDay)
	writer.WriteFloat64(a.Phone)
	writer.WriteFloat64(a.Siblings)
	writer.WriteFloat64(a.Spouse)
...
func (s *HproseSerializer) Unmarshal(d []byte, i interface{}) error {
	...
	o.Name, _ = reader.ReadFloat64()
	o.BirthDay, _ = reader.ReadFloat64()
	o.Phone, _ = reader.ReadFloat64()
	o.Siblings, _ = reader.ReadFloat64()
	o.Spouse, _ = reader.ReadFloat64()
...
func generateProto() []*ProtoBufA {
	...
	for i := 0; i < 1000; i++ {
		a = append(a, &ProtoBufA{
			Name:     proto.Float64(rand.Float64()),
			BirthDay: proto.Float64(rand.Float64()),
			Phone:    proto.Float64(rand.Float64()),
			Siblings: proto.Float64(rand.Float64()),
			Spouse:   proto.Float64(rand.Float64()),
...
func generateXDR() []*XDRA {
	...
	for i := 0; i < 1000; i++ {
		a = append(a, &XDRA{
			Name:     math.Float64bits(rand.Float64()),
			BirthDay: math.Float64bits(rand.Float64()),
			Phone:    math.Float64bits(rand.Float64()),
			Siblings: math.Float64bits(rand.Float64()),
			Spouse:   math.Float64bits(rand.Float64()),
